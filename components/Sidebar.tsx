...
export function Sidebar({ counts }: SidebarProps) {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 shrink-0 min-h-screen border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 sticky top-0 h-screen overflow-y-auto">
      ...
      {/* Footer */}
      <div className="px-6 py-4 border-t border-gray-100 dark:border-gray-800 flex items-center gap-2">
        {mounted && (
          <button
        ...
        <Link
          href="/private"
          className="p-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-gray-400 dark:text-gray-600 hover:text-gray-600 dark:hover:text-gray-400"
